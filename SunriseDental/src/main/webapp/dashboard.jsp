...
<div class="stats-grid">
    ...
    <a href="${pageContext.request.contextPath}/bills/list" class="stat-card" style="text-decoration:none; cursor:pointer; color:inherit;">
...
<div class="card">
    <div class="card-header" style="display:flex; justify-content:space-between; align-items:center;">
        ...
        <div style="display:flex; gap:8px;">
            ...
            <%
                com.sunrisedental.model.User dashUser = (com.sunrisedental.model.User) session.getAttribute("user");
                if (dashUser == null || !dashUser.isAdmin()) {
            %>
                ...
                <td class="action-icons" style="white-space:nowrap;">
                    ...
                    <% if (!"Completed".equals(r.getStatus()) && !"Cancelled".equals(r.getStatus())) { %>
                        <a href="${pageContext.request.contextPath}/appointments/complete/<%= r.getId() %>"
                           ...
                           onclick="return confirm('Complete appointment <%= r.getAppointmentNo() %> and proceed to Bill Generation?')">
                    ...
                    <a href="${pageContext.request.contextPath}/appointments/delete/<%= r.getId() %>"
                       class="btn-action-delete"
                       style="color:#ef4444;"
                       title="Delete Appointment (Admin Only)"
                       onclick="return confirm('Are you sure you want to permanently delete appointment <%= r.getAppointmentNo() %> for patient <%= r.getPatientName().replace("'", "\\'") %>?')">
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
